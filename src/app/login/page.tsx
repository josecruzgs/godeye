    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
      ...
      >
        <div className="flex flex-col items-center gap-2 text-center">
          <Image src="/media/logoblack.png" alt="Marina del Pilar · Yo con Julieta" width={44} height={44} className="object-contain dark:hidden" />
          <Image src="/media/logo.png" alt="Marina del Pilar · Yo con Julieta" width={44} height={44} className="hidden object-contain dark:block" />
